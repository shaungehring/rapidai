...
<div class="hero">
  ...
  <div style="margin-top: 2rem;">
    <a href="getting-started/installation/" class="md-button md-button--primary" style="margin: 0.5rem;">Get Started</a>
    <a href="tutorial/intro/" class="md-button" style="margin: 0.5rem;">View Tutorial</a>
...
<div style="text-align: center; padding: 2rem; color: var(--synthwave-cyan);">
  ...
  <a href="getting-started/installation/" class="md-button md-button--primary" style="font-size: 1.2rem; padding: 1rem 2rem;">Get Started Now →</a>
</div>
